...
class Label(SQLModel, table = True):
    __tablename__ = "label"
    __table_args__ = (UniqueConstraint("owner_id", "name", name = "uq_label_owner_name"),)       #Agrega una restricción para que sea única entre owner_id y name
...
class NoteLabelLink(SQLModel, table = True):
    ...
    __table_args__ = (UniqueConstraint("note_id", "label_id", name = "uq_note_label_owner_name"),)
    id: int = Field(default = None, primary_key=True)
